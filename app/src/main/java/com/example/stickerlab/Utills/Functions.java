...
public class Functions {
    ...
    public static void pickFile(Context context) {
        Intent intent = new Intent(Intent.ACTION_OPEN_DOCUMENT);
        intent.addCategory(Intent.CATEGORY_OPENABLE);
        intent.setType("*/*");
        ((Activity) context).startActivityForResult(intent, Constants.PICKFILE_REQUEST_CODE);
    }

    public static void pickVideoFromGallery(Context context) {
        Intent intent = new Intent();
        intent.setType("video/*");
        intent.setAction(Intent.ACTION_GET_CONTENT);
        ((Activity) context).startActivityForResult(Intent.createChooser(intent, "Select Video"), Constants.REQUEST_TAKE_GALLERY_VIDEO);
    }
 ...
 /*private static FirebaseAuth mAuth;
    ...
    public static double distanceCheck(double lat1, double lon1, double lat2, double lon2) {
    ...
    public static void pickImageFromGallery2(Context context) {
        Intent intent = new Intent();
        intent.setType("image/*");
        intent.setAction(Intent.ACTION_GET_CONTENT);
    ...
    public static void pickImageFromGallery3(Context context, int i) {
        Intent intent = new Intent();
        intent.setType("image/*");
        intent.setAction(Intent.ACTION_GET_CONTENT);
        ((Activity) context).startActivityForResult(
    ...
    public static void requestPermission(Context context) {
        if (SDK_INT >= Build.VERSION_CODES.R) {
            try {
                ...
                ((Activity) context).startActivityForResult(intent, Constants.PERMISSION_REQUEST_CODE);
            } catch (Exception e) {
                Intent intent = new Intent();
            ...
            ActivityCompat.requestPermissions(((Activity) context), new String[]{WRITE_EXTERNAL_STORAGE}, Constants.PERMISSION_REQUEST_CODE);
        }
    }
    public static boolean checkDirectory(Context context) {
        try {
            File path = Environment.getExternalStorageDirectory();
            File dir = new File(path + "/" + Constants.DIRECTORY_NAME + "/");
            dir.mkdirs();
            return true;
        } catch (Exception e) {
            e.printStackTrace();
...
//    ----------------------Kashif Shb -------------------------------------------------------
    ...
    public static void openAPK(Context context, File filePath) {
        try {
...
//    }
    ...
    public static void changestusbarColor(Context context, int color) {
        Activity activity = (Activity) context;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
    ...
    public static String changeDateFormat(String strCurrentDate, String currentFormat, String outputFormat) throws ParseException {
    ...
    public static void startActivityAnimRight(Context context) {
        ((Activity) context).overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
    }

    public static void closeActivityAnimLeft(Context context) {
    ...
    public static String getDateTime1(String time) {
        long milliSeconds = Long.parseLong(time);
        SimpleDateFormat formatter = new SimpleDateFormat("MMM dd,yyyy", Locale.ENGLISH);
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(milliSeconds);
    ...
    public static String getDateTimetest(String time) {
        long milliSeconds = Long.parseLong(time);
    ...
    public static String   getDateTime2(String time) {
        long milliSeconds = Long.parseLong(time);
    ...
    public static String getMilliSecondsForMainClander(String time) {
    ...
    public static String getMilliSeconds2(String time) {
    ...
    public static String getMilliSecond2(String time) {
    ...
    public static String getMilliSecond4(String time) {
    ...
    public static String getMilliSeconds1(String time) {
    ...
    public static String parseDateToddMMyyyy(String time) {
        ...
        String outputPattern = "dd/MM/yyyy HH:mm:ss Z";
